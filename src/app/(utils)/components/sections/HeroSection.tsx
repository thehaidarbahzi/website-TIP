...
export default function HeroSection() {
  ...
  return (
    <>
      <section
        id="hero"
        className="relative isolate flex min-h-[100svh] w-full overflow-hidden bg-[#DA4E86] text-white"
      >
        ...
        <div className="relative z-20 mx-auto flex w-full max-w-7xl flex-1 flex-col items-center px-4 sm:px-6 lg:px-8">
          <div className="flex w-full flex-1 flex-col items-center justify-center pt-[clamp(5.5rem,10vh,8.5rem)] pb-[clamp(8rem,14vh,10rem)] text-center">
            <h1
              ref={headingRef}
              className="max-w-5xl flex flex-col gap-5 text-[clamp(1.6rem,5vw,3.5rem)] font-extrabold uppercase leading-[0.95] tracking-[-0.04em] text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.16)]"
            >
            ...
            <p
              ref={paraRef}
              className="mt-6 max-w-3xl text-[clamp(1rem,1.8vw,1.35rem)] text-white/92"
            >
              Ikuti kompetisi inovasi teknologi UGM dan hadirkan solusi inovatif
              untuk mendukung kemajuan industri serta kemandirian teknologi
              Indonesia.
            </p>
