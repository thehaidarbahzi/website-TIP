...
export default function AboutUsSection() {
  ...
  useEffect(() => {
    ...
    const cards = [cendekiaRef.current, lpktaRef.current].filter(Boolean) as HTMLElement[];
  ...
  return (
      <section id="about" className="panel items-center justify-center overflow-y-auto">
      <div className="max-w-6xl mx-auto px-6 w-full flex flex-col justify-center pt-24 pb-16">
        ...
        <div ref={cardsWrapperRef} className="flex flex-col lg:flex-row gap-12 items-stretch justify-center">
          <div ref={cendekiaRef} className="flex flex-col bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white flex-1 relative overflow-hidden">
          ...
          <div ref={lpktaRef} className="flex flex-col bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white flex-1 relative overflow-hidden">
        ...
        <div ref={footerRef} className="mt-16 text-center text-slate-500 text-sm">
