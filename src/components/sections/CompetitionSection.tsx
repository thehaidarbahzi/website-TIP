      ...
      <div className="max-w-6xl mx-auto px-6 w-full flex flex-col justify-center h-full pt-8 md:pt-96">
        <div ref={headerRef} className="text-center mb-16">
          ...
          <p className="text-slate-700 max-w-2xl mx-auto">
            Pilih kategori yang sesuai dengan jenjang pendidikanmu dan tunjukkan
            kemampuan terbaikmu!
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="text-slate-600 mb-6 flex-grow">
              Kompetisi karya tulis ilmiah dan essay tingkat nasional untuk
              mahasiswa/i aktif D3/D4/S1 seluruh Indonesia.
            </p>
          ...
          >
            ...
            <p className="text-[var(--color-brand-pink)] font-semibold mb-4">
              Lomba Poster
            </p>
            <p className="text-slate-600 mb-6 flex-grow">
              Ajang unjuk kreativitas melalui desain poster informatif dan
              menarik untuk siswa SMA/sederajat seluruh Indonesia.
            </p>
            <ul className="space-y-2 mb-8 text-sm text-slate-600">
              <li className="flex items-center gap-2">✓ Desain orisinal</li>
              <li className="flex items-center gap-2">
                ✓ Individu atau tim (maks 3 orang)
              </li>
              <li className="flex items-center gap-2">
